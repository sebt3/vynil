...
impl InstanceKind for ServiceInstance {
    fn type_name() -> &'static str { "service" }
    fn finalizer_name() -> &'static str { "serviceinstances.vynil.solidite.fr" }
    fn package_type() -> VynilPackageType { VynilPackageType::Service }
