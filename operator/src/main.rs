...
async fn main() -> Result<()> {
    ...
    let (manager, controller_dist, controller_inst) = Manager::new().await;
    ...
    tokio::select! {
        _ = controller_inst => warn!("Install controller exited"),
        _ = controller_dist => warn!("Distrib controller exited"),
